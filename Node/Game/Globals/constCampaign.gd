...
const arena:Array = [
	preload("res://Node/Arena/Debug/PLACEHOLDER_EASY_WIN.tscn"),
...
const campaignDialog:Array = [
	...
	[
		...
		[INTRO,[SPRITE_DOKI,EFFECT_GREY,SPRITE_DRAGOON_CHICK_ALLIED,EFFECT_NONE],
			"Hummm... there is no Base in this map."],
		[INTRO,[SPRITE_DOKI,EFFECT_GREY,SPRITE_DRAGOON_CHICK_ALLIED,EFFECT_NONE],
			"We should use the Cities we capture to regain force and push forward."],
		...
		[OUTRO,[SPRITE_DRAGOON_CHICK_ALLIED,EFFECT_NONE,SPRITE_DRAGOON_CHICK_ENNEMY,EFFECT_GREY],
			"It seems getting beaten up knocked some sense into them."],
		...
		[OUTRO,[SPRITE_DOKI,EFFECT_NONE,SPRITE_DRAGOON_CHICK_ENNEMY,EFFECT_GREY],
			"Alright, everyone pack up! Let's find that imposter!"],
	...
	[
		[INTRO,[null,EFFECT_NONE,null,EFFECT_NONE],
			"Hon hon hon..."],
		[INTRO,[null,EFFECT_NONE,null,EFFECT_NONE],
			"Don't let this impostor pass the bridge my little Dragoons."],
	...
	[
		...
		[INTRO,[SPRITE_DOKI,EFFECT_GREY,SPRITE_TRICKSTER,EFFECT_NONE],
			"I've got troups and I'm in very good position!"],
	...
	[
		...
		[INTRO,[SPRITE_DOKI,EFFECT_GREY,SPRITE_DRAGOON_CHICK_ALLIED,EFFECT_NONE],
			"And thoses are his last troops! Let's finish this!"],
		[OUTRO,[SPRITE_DOKI,EFFECT_NONE,null,EFFECT_NONE],
	...
	[
		[INTRO,[null,EFFECT_NONE,SPRITE_MALEVOLENT,EFFECT_NONE],
			"MUHAHAHAHAHA! I KNOW THAT THE LORD OF THOSES LAND ARE TOTALLY UNPREPARED"],
		[INTRO,[null,EFFECT_NONE,SPRITE_MALEVOLENT,EFFECT_NONE],
			"IT WILL BE A PIECE OF CAKE TO CONQUER THOSES..."],
		[INTRO,[null,EFFECT_NONE,SPRITE_MALEVOLENT,EFFECT_NONE],
			"WAIT..."],
		...
		[OUTRO,[SPRITE_DOKI,EFFECT_GREY,SPRITE_MALEVOLENT,EFFECT_NONE],
			"I WILL BE BACK..."],
		[OUTRO,[SPRITE_DOKI,EFFECT_NONE,SPRITE_MALEVOLENT,EFFECT_NONE],
			"That was a day!"],
		[OUTRO,[SPRITE_DOKI,EFFECT_NONE,SPRITE_MALEVOLENT,EFFECT_NONE],
			"Wonder where that stupid jester is..."],
